...
<div class="tab-content">
      <div class="tab-pane active" id="faq">
        <div class="wrapper">
		  <h2>I have a black screen at startup, what can I do?</h2>
		  ...
		  <br>
		  <br>
		  <h2>Game crashes when ALT+TABbing.</h2>
		  ...
		  <br>
		  <br>
		  <h2>Game crashes at startup. [Fixed in v.203]</h2>
		  ...
		  <br>
		  <br>
		  <h2>Game doesn't checkpoint anymore or autosave at certain points of the game! [Fixed in v.203]</h2>
		  ...
		  <br>
		  <br>
		  <h2>Game crashes when I go to desktop and go to an app or program.</h2>
		  ...
		  <br>
		  <br>
		  <h2> QTE not responding to the buttons that I'm pressing. [Fixed in v.203]</h2>
