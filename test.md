...
<input name="sum" style="width:200px;height:100px" value="100"/><input type="hidden" name="origin" value="button"/><input type="hidden" name="quickpay-form" value="small"/>
...
<input type="submit" style="width:200px;height:100px" value="Support the project"/></form></div></td></tr></table>
