...
<input type="hidden" name="targets" value="На хорошее дело не жалко!"/><input type="hidden" name="comment" value="Пожертвование через виджет «Мой баланс»"/>
<input type="submit" style="width:100%" value="Поддержать проект"/></form></div></td></tr></table>
